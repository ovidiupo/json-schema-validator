import { ValidatorType, StringValidatorOptions, ValidatorOptions, RegExpValidatorOptions, ValidationSchema, MinMaxValidatorOptions, ValidatorFnc } from "./types";
...
export function validate(body: any, validations: ValidationSchema) {
